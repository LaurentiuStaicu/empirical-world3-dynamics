...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="readme-assets/ewd-concept-overview-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="readme-assets/ewd-concept-overview-light.svg">
    <img src="readme-assets/ewd-concept-overview-light.svg" width="760" alt="Diagram showing the World3-03 core, empirical layer, calibration, validation and inactive extension gates.">
  </picture>
</p>
...
See [.github/workflows/science-reproducibility.yml](workflows/science-reproducibility.yml) for the canonical automated path.
...
For reproducible software/reproduction problems or scientific/model concerns, use the structured repository issue forms. See [Contributing](CONTRIBUTING.md) and [Support](SUPPORT.md).
